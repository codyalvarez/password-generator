# PasswordGenerator
Basic password generator with 3 different password options:
    - numbered
    - aphelbatized
    - mixed

Put your Ruby code in the file `lib/password_generator`. To experiment with that code, run `bin/console` for an interactive prompt.
